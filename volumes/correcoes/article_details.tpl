	...
	<div class="row">
		<div class="main_entry">
			...
			<div class="item badges">
				<div class="__dimensions_badge_embed__" data-doi="{$pubId}" data-style="medium circle" data-legend="always"></div>
			...
			<div class='altmetric-embed' data-badge-type='donut' data-badge-details='right' data-doi="{$pubId}" style="margin: 2rem;"></div>
			{/if}
			{/foreach}
			{* END *}
